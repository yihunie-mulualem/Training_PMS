...
namespace PerMS.Controllers
{
    ...
    public class ClusterController : Controller
    {
        ...
        public ClusterController(PerMSContext context)
        {
            _context = context;
        }
        [HttpGet]
        [Route("api/[controller]/GetCluster")]
        public async Task<ActionResult<IEnumerable<Cluster>>> GetCluster()
        {
            try
            {
                var cluster = await _context.Clusters.ToListAsync();
        ...
        public IActionResult InsertCluster(Cluster cluster)
        {
            try
            {
        ...
        public IActionResult UpdateCluster(Cluster cluster)
        {
            try
            {
                ...
                var existingCluster = _context.Clusters.Find(cluster.Id);
